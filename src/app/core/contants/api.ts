...
export const API_URL_ARQU = environment.apiUrl + '/arquetipo'
export const API_URL_CAMI = environment.apiUrl + '/caminho'
export const API_URL_USER = environment.apiUrl + '/user'
export const API_URL_LIVRO = environment.apiUrl + '/livro'
